...
|---|---|---|---|
| 1 | 제안서 승률 개선: 거절 사유 패턴 분석 + 제안서 구조 리팩터링 | PENDING | `offer-build-kit/10-proposal-template.md` + `execution-playbook.md` |
| 2 | 리드 우선순위 자동화: 오늘 연락할 Top5 추출 규칙 설계 | PENDING | `execution-playbook.md` (BIZ-122) + `unit-economics-dashboard.md` |
...
| 9 | Delivery 아키텍처 고도화 (역할/의사결정 책임표) | PENDING | `offer-build-kit/05-delivery-architecture.md` |
